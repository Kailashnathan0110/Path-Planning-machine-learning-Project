...
def main():
    ...
    planner_nastar = aStar.NeuralAstar(encoder_arch="CNN",
                                ...
                                Tmax=1.0)
    planner_nastar.load_state_dict(training.load_from_ptl_checkpoint("model/mazes_032_moore_c8"))
    ...
    clip.write_gif("OutputResult/Video_mazes_032_moore_c8_astar.gif")
    frames_nastar = [
        data.visualize_results(
    ...
    clip_nastar.write_gif("OutputResult/Video_mazes_032_moore_c8_neuralastar.gif")
